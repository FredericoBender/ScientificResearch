...
public class parseParameters {
     ...
     *
     */
    public void parseConfigurationFile(String fileName,int j, int crossValidationSyze, String dataSetName) {
        ...
        readInputFiles(line,j,crossValidationSyze,dataSetName); //We read all the input files
     ...
     */
    private void readInputFiles(StringTokenizer line, int j, int crossValidationSyze, String dataSetName){
        ...
        trainingFile = "./data/"+dataSetName+"/"+dataSetName+"-"+crossValidationSyze+"-"+j+"tra.dat";
        validationFile = "./data/"+dataSetName+"/"+dataSetName+"-"+crossValidationSyze+"-"+j+"tra.dat";
        testFile = "./data/"+dataSetName+"/"+dataSetName+"-"+crossValidationSyze+"-"+j+"tst.dat";
        System.out.println("\n\n"+trainingFile);
